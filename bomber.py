...
def do_zip_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("nether was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update nether")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/d3/TBomb.git")
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("nether bombis up-to-date")
        mesgdcrt.GeneralMessage("Starting nether bomb")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("netherbomb was created by d3ac3301")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("nether bomb" will work only in Python v3")
    sys.exit()
...
description = ""netherbomb- Your Friendly Spammer Application

netherbomb can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

 nether is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by manas george !!!')
