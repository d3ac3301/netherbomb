...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32md3ac3301 \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border d3ac3301
    fi
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By d3ac3301 > .update
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN nether bomb Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
